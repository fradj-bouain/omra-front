...
const FALLBACK_FR: Record<string, string> = {
  ...
  'login.brandTitle': 'Hajj & Omra',
  'login.brandTagline': 'Espace agence — accompagner le pèlerin avec sérénité.',
  'login.formEyebrow': 'Accès sécurisé',
  'login.heroMotto': 'Groupes, dossiers et parrainage — un même lieu pour votre agence.',
  'nav.dashboard': 'Dashboard',
  'nav.pilgrims': 'Pèlerins',
  'nav.groups': 'Groupes Omra',
  'nav.flights': 'Vols',
  'nav.hotels': 'Hôtels',
  ...
  'nav.group.participants': 'Pèlerins & groupes',
  ...
  'pilgrims.mo3tamir.pageTitleNew': 'Nouveau mo3tamir (pèlerin)',
  'pilgrims.mo3tamir.pageTitleEdit': 'Modifier le pèlerin',
  ...
  'pilgrims.mo3tamir.createPilgrim': 'Créer le pèlerin',
  'pilgrims.mo3tamir.createFamily': 'Créer {{n}} pèlerins',
  'pilgrims.mo3tamir.familyCreated': '{{n}} pèlerins créés avec succès.',
  'pilgrims.mo3tamir.familyCreateError': 'Erreur lors de la création d’un membre de la famille.',
  'pilgrims.mo3tamir.familyDocsHint':
    'En mode famille, ajoutez les pièces jointes depuis la fiche de chaque pèlerin après création (liste des pèlerins).',
